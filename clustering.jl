...
# ╔═╡ 907367e4-328a-4480-a5c4-54c9a26b0016
function getContent()
	df = DataFrame(load("/home/gonza/Descargas/spotify_data.csv"))
end

# ╔═╡ 5e48721d-01b5-40d7-a714-f4658d365eee
begin
	df = getContent()
	println(size(df))
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "8c682f12c133dac6e9bd78e22dde45f60b5cce8a"
