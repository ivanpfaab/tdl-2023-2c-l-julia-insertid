...
begin
	...
	bar(cluster_counts.cluster, cluster_counts.nrow, xlabel="Cluster", ylabel="Número de elementos", label="Counts", legend=:top)
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "52048470d97e8b1a67ab53605d278e3d1d48516f"
